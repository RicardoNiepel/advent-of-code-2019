...
func Test_partone_small(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			"",
			"109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,16,1",
			"109\n1\n204\n-1\n1001\n100\n1\n100\n1008\n100\n16\n101\n1006\n101\n0\n99",
		},
		{
...
func Test_partone_main(t *testing.T) {
	...
	inputIntcode := string(dat)
	_, output := run(inputIntcode, "1")

	assert.Equal(t, "2594708277", output)
}
...
func Test_parttwo_main(t *testing.T) {
	...
	inputIntcode := string(dat)
	_, output := run(inputIntcode, "2")

	assert.Equal(t, "87721", output)
}

func Test_day7_partone_small(t *testing.T) {
	tests := []struct {
		inputIntcode              string
...
func Test_day7_partone_main(t *testing.T) {
	dat, err := ioutil.ReadFile("input_day7.txt")
	if err != nil {
		panic(err)
	}
	input := string(dat)
...
func Test_day7_parttwo_small(t *testing.T) {
	tests := []struct {
		inputIntcode              string
		expectedPhaseSetting      string
		expectedMaxThrusterSignal string
...
func Test_day7_parttwo_main(t *testing.T) {
	dat, err := ioutil.ReadFile("input_day7.txt")
	if err != nil {
		panic(err)
	}
